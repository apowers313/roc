...
import { __resetSocketForTesting, useGameState, useRunSubscription } from "./useRunSubscription";
...
describe("useGameState", () => {
    ...
    it("tolerates a failing /api/game/status fetch", async () => {
